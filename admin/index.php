...
<div class="admin-dashboard-stats" style="display: flex; gap: 20px; margin-bottom: 2rem;">
    <div class="stat-card" style="flex: 1; padding: 20px; background: #f0f0f0; text-align: center; border-radius: 5px;">
        ...
        <p>Total Medicines</p>
        <a href="<?php echo BASE_URL; ?>/admin/medicines.php" class="btn btn-secondary">Manage Medicines</a>
    </div>
    <div class="stat-card" style="flex: 1; padding: 20px; background: #f0f0f0; text-align: center; border-radius: 5px;">
    ...
    <div class="stat-card" style="flex: 1; padding: 20px; background: #f0f0f0; text-align: center; border-radius: 5px;">
        ...
        <a href="<?php echo BASE_URL; ?>/admin/bookings.php" class="btn btn-secondary">Manage Bookings</a>
    </div>
     <div class="stat-card" style="flex: 1; padding: 20px; background: #f0f0f0; text-align: center; border-radius: 5px;">
        <h2><?php echo $unread_advice_count; ?></h2>
        <p>Unread Advice Requests</p>
        <a href="<?php echo BASE_URL; ?>/admin/advice_requests.php" class="btn btn-secondary">View Requests</a>
    </div>
</div>

<h2>Quick Actions</h2>
<ul>
    <li><a href="<?php echo BASE_URL; ?>/admin/medicines.php?action=add">Add New Medicine</a></li>
    <li><a href="<?php echo BASE_URL; ?>/admin/categories.php?action=add">Add New Category</a></li>
    <li><a href="<?php echo BASE_URL; ?>/admin/stock.php">Manage Stock</a></li>
</ul>
